...
void cortar(int altura, int largura, int matriz[altura][largura], char resultado[]){
    ...
    // x qtde linhas, y qtde colunas
    // m1 = matriz de 0 até(<) X1 e Y1, tamanho [X1][Y1]
    // m2 = matriz de 0 até X2 e Y1 até largura, se X2 !=0, tamanho[X1][Y2]
    // m3 = matriz de X1 até altura e de 0 até Y1, se , tamanho[X2][Y1]
    // m4 = matriz de X1 até altura e Y2 até largura, tamanho[X2][Y2]
}
